...
performAction args (Content config)
  ...
  | member ENCRYPT args = encryptionWrapper args (removeId <. encrypt . addId) (args ! ENCRYPT)
  | member DECRYPT args = encryptionWrapper args (removeId <. decrypt . addId) (args ! DECRYPT)
