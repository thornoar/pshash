...
This simple cipher is included in \texttt{pshash}'s primary implementation. By invoking \verb|$ pshash -e FILE|, the user will be prompted for the destination \verb|OUT|, as well as two keys, after which the contents of \verb|FILE| will be shuffled and written to \verb|OUT|. The program can read from \texttt{stdin} and write to \texttt{stdout} if \verb|FILE| is \verb|"stdin"| or \verb|OUT| is \verb|"stdout"|. Of course, both keys can be specified as arithmetic expressions or mnemonic incantations.
